...
public class ScheduleUtils {
	...
	public static void createScheduleJob(QuartzJobEntity scheduleJob) {
		...
		try {
			...
			//放入参数，运行时的方法可以获取
			jobDetail.getJobDataMap().put(QuartzJobEntity.JOB_PARAM_KEY, scheduleJob);
	...
	public static void updateScheduleJob(QuartzJobEntity scheduleJob) {
		try {
			...
			trigger.getJobDataMap().put(QuartzJobEntity.JOB_PARAM_KEY, scheduleJob);
	...
	public static void run(QuartzJobEntity scheduleJob) {
		...
		dataMap.put(QuartzJobEntity.JOB_PARAM_KEY, scheduleJob);
